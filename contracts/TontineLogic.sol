...
contract TontineLogic is RedirectAll {
    ...
    constructor(uint256 _roundDuration, uint256 _monthlyContribAmount, ISuperToken _acceptedToken, ISuperfluid _host, address _owner, address _membershipNFTAddress) RedirectAll(_acceptedToken, host, _owner) {
    ...
    function switch() public {
        require((currentPeriod + 1 month) < block.timestamp, "Too soon to switch")
